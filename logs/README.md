...
`v4/experiment-v4-step2-regime-overlay.txt` records the frozen Step 2 development
baseline. Passing its pillars authorizes only continued staged research, not a
